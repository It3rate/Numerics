...
public class PRangeConversionTests
{
    ...
    private Number _domainBasis = null!;
    private Number _invDomainBasis = null!;
    ...
    public void Init()
    {
        ...
        _domainBasis = _domain.DefaultBasisNumber;
        _invDomainBasis = _invDomain.DefaultBasisNumber;
    }
    [TestMethod]
    public void MultiplyAlignedTests()
    {
        var n1 = new Number(_domainBasis, new(2000, 3000)); // (-2i+3)
        var n2 = new Number(_domainBasis, new(0, -1000)); // (-1)
    ...
    {
        var n1 = new Number(_domainBasis, new(2000, 3000)); // (-2i+3)
        var n2 = new Number(_domainBasis, new(-1000, 0)); // (i)
        var pr1 = PRange.FromNumber(n1);
        var pr2 = PRange.FromNumber(n2);
        var result = n1 * n2;
        var prResult = pr1 * pr2;
    ...
    {
        var n1 = new Number(_domainBasis, new(2000, 3000)); // (-2i+3)
        var n2 = new Number(_invDomainBasis, new(0, -1000)); // ~(1)
        var pr1 = PRange.FromNumber(n1);
        var pr2 = PRange.FromNumber(n2);
        var result = n1 * n2;
    ...
    public void UnitByAlignedTests()
    {
        ...
        var i_neg1 = new Number(_invDomain.DefaultBasisNumber, new(-100, 0)); // ~seg from 1->0i inverts segments in place
        var r0 = n * i_neg1; // ~(-1)
        ...
        var i_pos1 = new Number(_invDomain.DefaultBasisNumber, new(100, 0)); // ~seg from 1->0i inverts segments in place
        var r1 = n * i_pos1; // ~(1)
    ...
    public void DivisionTests()
    {
        ...
        _limits = new Focal(-10000, 10000);
        _domain = new Domain(_trait, _basisFocal, _limits);
        var n = new Number(_domainBasis, new(4000, 5000)); // (-4i+5)
        var prn = PRange.FromNumber(n);

        var denom = new Number(_domainBasis, new(-2000, 3000)); // (2i+3)
        var r4 = n / denom;
    ...
    public void Division_invTests()
    {
        ...
        _domain = new Domain(_trait, _basisFocal, _limits);
        var n = new Number(_domainBasis, new(40000, 50000)); // (-4i+5) => ~(4-5i)
        var prn = PRange.FromNumber(n);

        var denom = new Number(_invDomainBasis, new(-20000, 30000)); // ~(-2-3i) => (2i+3)
